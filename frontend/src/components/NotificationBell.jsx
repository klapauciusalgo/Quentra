...
export default function NotificationBell({
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      {isOpen && (
        <div className="notification-flyout absolute right-0 top-11 w-[min(20rem,calc(100vw-1rem))] sm:w-96 max-w-[calc(100vw-1rem)] rounded-2xl bg-white/95 dark:bg-[#0E1017]/95 backdrop-blur-2xl border border-black/10 dark:border-white/15 shadow-2xl p-4 z-50 text-xs text-apple-text animate-in fade-in zoom-in-95 duration-150">
