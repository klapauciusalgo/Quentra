...
export default function StrategyRibbon({ 
  ...
  return (
    <div className="apple-glass rounded-3xl p-4 sm:p-6 space-y-5">
      ...
      {/* Strategy Segmented Pills (Longs & Shorts) */}
      <div className="space-y-2.5">
        {/* Long Strategies */}
        <div className="flex flex-wrap items-center gap-1.5">
          <span className="text-[11px] font-semibold text-apple-muted uppercase tracking-wider w-16 shrink-0">
            Long
          </span>
          <div className="flex flex-wrap items-center gap-1.5">
            {longStrategies.map((s) => {
              ...
              return (
                <button
                  ...
                  className={`px-3 py-1.5 text-xs rounded-xl border transition-all flex items-center gap-2 cursor-pointer ${
                    isSelected
      ...
      {/* Selected Strategy Detail Bento Card */}
      {activeStrat && (
        <div className="apple-glass-card rounded-2xl p-5 md:p-6 grid grid-cols-1 lg:grid-cols-12 gap-6">
